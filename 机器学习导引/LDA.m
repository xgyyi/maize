...
% 就是Sw是否可逆，遗憾的是在实际的应用中，它通常是不可逆的，我们通常有两个办法解决它。
...
%                       data point. 列向量，标签label
%               options - Struct value in Matlab. The fields in options
%                         that can be set:
%
%                            Regu  -  1: regularized solution, 正则化求解
...
%               eigvalue  - The sorted eigvalue of LDA eigen-problem. 特征值
